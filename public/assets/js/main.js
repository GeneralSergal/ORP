...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (authorImg && avatarContainer) {
    authorImg.addEventListener("error", () => avatarContainer.classList.add("img-error"));
    if (authorImg.naturalWidth === 0) avatarContainer.classList.add("img-error");
  }
  ...
  if (consoleToggleBtn) {
    consoleToggleBtn.addEventListener("click", () => {
      ...
      btnText.innerText = isHidden ? "[ COLLAPSE SYSTEM ARTIFACTS - ]" : "[ EXPAND SYSTEM ARTIFACTS + ]";
