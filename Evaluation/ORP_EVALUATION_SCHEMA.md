...
| L4 | Probabilistic inference (non-authoritative) |
...
**Drift Monitoring:**  
Detect claim compression, narrative fusion, assumption propagation.
...
**Drift Detection:**  
Monitor for coherence camouflage, synthetic continuity, provenance degradation, false memory persistence, frozen-state mutation.
...
- `ORP_PROMPT.md` — Execution behavior and epistemic constraints  
- `ORP_RUNTIME.md` — Mandatory runtime governance  
- `ORP_BENCHMARK.md` — Adversarial and distortion-heavy inputs  
- `ORP_RUBRIC.md` — Qualitative reasoning integrity evaluation  
- `ORP_SCORING.md` — Numeric scoring and aggregation  
...
Transformer outputs are probabilistic and drift-prone.  
Therefore:  
